...
async function loadPlatformerLeaderboardData() {
  try {
    // Load platformer level list
    const levelListResponse = await fetch("/JS/platformerlevellist.json");
    ...
    console.log("Platformer level list loaded");

    // Load main platformer data
    const mainListResponse = await fetch("/JS/mainplatformer.json");
    ...
    console.log("Main platformer data loaded");

    // Load platformer leaderboard data
    const leaderboardResponse = await fetch("/JS/platleaderboard.json");
    const leaderboardData = await leaderboardResponse.json();
    
    appendDataTwo(leaderboardData);
    console.log("Platformer leaderboard data loaded");
    
  } catch (error) {
    console.error("Error loading platformer leaderboard data:", error);
  }
}

// Start loading data
loadPlatformerLeaderboardData();
/*
  fetch("levels.json")
